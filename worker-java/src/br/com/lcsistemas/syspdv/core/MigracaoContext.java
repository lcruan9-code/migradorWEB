...
public class MigracaoContext {
    ...
    // ── SqlMemoryStore (stub — sempre null; AjusteGeralStep usa H2 via JDBC) ──
    public SqlMemoryStore getMemoryStore() { return null; }
    public void setMemoryStore(SqlMemoryStore s) { /* no-op — H2 substitui este modo */ }
