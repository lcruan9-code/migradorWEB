...
public class AjusteGeralStep extends StepBase {
    ...
    // =========================================================================
    /**
     * @param cidadeDefault id de lc_sistemas.cidades usado como fallback
     *                      quando o ClienteStep não conseguiu resolver pelo nome
     * @param estadoDefault id de lc_sistemas.estados usado como fallback
     */
    private void ajustarCliente(Connection c, int cidadeDefault, int estadoDefault) {
        ...
        // Aplica os defaults configurados na tela do programa (cidadeDefaultId /
        // estadoDefaultId) para clientes cujo nome de cidade não foi resolvido
        // no ClienteStep. Cidade e estado são configurados INDEPENDENTEMENTE
        // na UI — nunca derivar um do outro via JOIN.
        if (cidadeDefault > 0) {
            execIgnore(c,
