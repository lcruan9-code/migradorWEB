...
public class MainFrame extends javax.swing.JFrame
    ...
    private void initComponents() {
        ...
        lblSubtitulo.setText("Migração GDOOR");
        ...
        jlogo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/lcsistemas/gdoor/icon/lc_logoSofthouse_para_fundo_escuro2.png"))); // NOI18N
        ...
        btnCarregarCidades.setText("↺ Recarregar");
...
private void inicializarAjusteLogo() {
    ...
    private MigracaoConfig montarConfig() {
        // Validação básica
        if (txtFbArquivo.getText().trim().isEmpty()) {
            JOptionPane.showMessageDialog(this,
                "Selecione o arquivo .fdb do GDOOR (Aba 2).",
        ...
        try {
            String cnpjDigitado = txtClienteNome.getText().trim();
            MigracaoConfig cfg = new MigracaoConfig();
            cfg.setEmpresaCnpj(cnpjDigitado);  // usa default interno se vazio
